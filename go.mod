module github.com/hello-xone/xone-chain
...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/hello-xone/xone_cosmos-sdk v1.0.1
	// github.com/cosmos/cosmos-sdk => ../xone-cosmos-sdk
	// use Evmos geth fork
